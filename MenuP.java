...
public class MenuP extends JFrame implements MouseMotionListener{
    ImageIcon selImagePlay;
    ImageIcon selImageDevs;
    ImageIcon backgroundImage=new ImageIcon("./res/Menu/background.png");
    ImageIcon buttonPlayNormal=new ImageIcon("./res/Menu/buttonPlayNormal.png");
    ImageIcon buttonDevsNormal=new ImageIcon("./res/Menu/buttonDevsNormal.png");
    ...
    private void startZombieChaosAudio(){
     String filePath="./res/audio/zombie_chaos.wav";
